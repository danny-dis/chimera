...
This project is indexed by GitNexus as **chimera** (6469 symbols, 15196 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
