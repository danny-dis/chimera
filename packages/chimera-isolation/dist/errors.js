...
exports.IsolationBlockedError = void 0;
exports.classifyIsolationError = classifyIsolationError;
exports.isKnownIsolationError = isKnownIsolationError;
// ---------------------------------------------------------------------------
...
exports.IsolationBlockedError = IsolationBlockedError;
 ...
 */
function classifyIsolationError(err) {
 ...
 */
function isKnownIsolationError(err) {
    const stderr = err.stderr ?? '';
    const errorLower = `${err.message} ${stderr}`.toLowerCase();
