...
exports.workflowNodeHooksSchema = void 0;
/**
 ...
 */
exports.workflowNodeHooksSchema = zod_1.z.object({
    /** Shell command run before the node's primary action. */
    pre_run: zod_1.z.string().min(1, "'hooks.pre_run' must be a non-empty string").optional(),
});
