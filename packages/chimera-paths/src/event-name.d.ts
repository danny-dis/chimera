 ...
 */
export type LogState = 'started' | 'completed' | 'failed' | 'validated' | 'rejected' | 'selected' | 'registered' | 'received' | 'loaded' | 'discovered' | 'adopted' | 'pruned' | 'applied' | 'detected' | 'created' | 'destroyed' | 'updated' | 'initialized' | 'skipped';
/**
 ...
 * state.
 */
export declare function logEvent(domain: string, action: string, state: string): string;
