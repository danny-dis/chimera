...
const CHIMERA_MODES: BundledSkill = {
  name: 'chimera-modes',
...
const CHIMERA_WORKFLOWS: BundledSkill = {
...
const CHIMERA_SAFETY: BundledSkill = {
  name: 'chimera-safety',
...
const CHIMERA_TOOL_LOOP: BundledSkill = {
...
const CHIMERA_CLI: BundledSkill = {
  name: 'chimera-cli',
...
const CHIMERA_TELEMETRY: BundledSkill = {
...
const CHIMERA_COST_CONTROL: BundledSkill = {
...
const CHIMERA_LEARNING: BundledSkill = {
 ...
 */
export const BUNDLED_SKILLS: Readonly<Record<string, BundledSkill>> = Object.freeze({
