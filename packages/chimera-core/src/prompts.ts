 ...
 */
export const CONVERSATIONAL_IDENTITY = `[!] CHIMERA — CONVERSATIONAL MODE [!]
 ...
 */
export const COMPACT_CORE_IDENTITY = `[!] CHIMERA CORE PACT [!]
 ...
 */
export const SMALL_MODEL_GUIDANCE = `SMALL MODEL MODE:
 ...
 */
export const TOOL_USE_GUIDANCE = `Translate the user's plain words into the right tool — act, don't narrate:
 ...
 */
export function compactAgentPrompt(role: AgentRole): string {
  const writer =
    `[!] WRITER ROLE [!]
