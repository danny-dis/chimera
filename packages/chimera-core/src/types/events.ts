...
export const ChimeraEventSchema = z.discriminatedUnion('type', [
  ...
  z.object({
    type: z.literal('preset_resolution_started'),
    preset: z.string(),
    roles: z.array(z.string()),
    backend: z.string(),
  }),
  z.object({
    type: z.literal('preset_role_resolved'),
    preset: z.string(),
    role: z.string(),
    alias: z.string(),
    backend: z.string(),
  ...
  z.object({
    type: z.literal('preset_resolution_complete'),
    preset: z.string(),
    resolvedRoles: z.array(z.string()),
    failedRoles: z.array(z.string()),
    durationMs: z.number(),
  }),
  z.object({
    type: z.literal('preset_fallback'),
    preset: z.string(),
    role: z.string(),
    alias: z.string(),
    reason: z.string(),
