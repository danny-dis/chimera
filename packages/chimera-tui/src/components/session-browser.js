...
export const SessionBrowser = ({ sessions, onSelect, onDelete, }) => {
    ...
    return (<Box flexDirection="column" borderStyle="double" borderColor={zen.agent} paddingX={1}>
      <Box marginBottom={1}>
      ...
      {sessions.map((session, i) => {
            ...
            return (<Box key={session.id} flexDirection="column">
            <Box>
            ...
            {isSelected && isConfirming && (<Box marginLeft={4}>
