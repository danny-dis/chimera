...
export class SessionExporter {
    exportBundle(sessions, checkpoints, options = {}) {
    ...
    async exportToFile(filePath, sessions, checkpoints, options = {}) {
    ...
    static getDefaultValidationRules() {
        return [
            {
                validate: (data) => typeof data === 'object' && data !== null && 'metadata' in data && 'sessions' in data && 'checkpoints' in data,
...
export class SessionImporter {
    ...
    mergeWithExisting(imported, existingSessions, existingCheckpoints) {
        const errors = [];
