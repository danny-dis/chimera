...
exports.CAPABILITY_TIPS = void 0;
exports.tierMessage = tierMessage;
exports.depthMessage = depthMessage;
exports.suggestNextValue = suggestNextValue;
/** Resolve the right string for the current skill tier. */
function tierMessage(msg, tier) {
    return msg[tier];
}
/** Resolve by explanation depth (more explicit than tier). */
function depthMessage(msg, depth) {
    switch (depth) {
        case 'full':
            return msg.beginner;
        case 'minimal':
 ...
 */
function suggestNextValue(model, seen, opts = {}) {
    ...
    if (pick) {
        return {
            id: pick,
            tip: tier === 'advanced' ? exports.CAPABILITY_TIPS[pick].advanced : exports.CAPABILITY_TIPS[pick].beginner,
    ...
    if (fallbacks.length > 0) {
        ...
        return {
            id: fb,
            tip: (tier === 'advanced' ? exports.CAPABILITY_TIPS[fb].advanced : exports.CAPABILITY_TIPS[fb].beginner),
