...
export type IssueType = 'skill-not-followed' | 'workflow-deviation' | 'tool-friction' | 'cost-inefficient' | 'quality-failure';
...
export interface ImprovementSignal {
    artifact: {
        type: 'skill' | 'workflow' | 'skill-pack';
        name: string;
    };
    sessions: SessionPattern[];
...
export interface ArtifactInventory {
    skills: Array<{
        name: string;
        source: 'bundled' | 'synthesized' | 'user';
        lastUpdated: string;
    }>;
    workflows: Array<{
        name: string;
