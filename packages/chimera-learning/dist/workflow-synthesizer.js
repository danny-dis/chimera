...
exports.WorkflowSynthesizer = void 0;
const TOOL_ROLES = {
    read_file: 'read',
    list_files: 'read',
    search_files: 'search',
...
// ---------------------------------------------------------------------------
function mapSequenceToSteps(sequence, _domain) {
    const steps = [];
    let stepCounter = 0;
...
// ---------------------------------------------------------------------------
function generateWorkflowName(domain, patterns) {
...
function generateWorkflowDescription(domain, patterns) {
    const successRate = patterns.filter(p => p.quality.status === 'done').length / patterns.length;
    return (`Auto-generated workflow for ${domain} tasks. ` +
...
class WorkflowSynthesizer {
     ...
     */
    synthesizeFromSequence(sequence) {
...
exports.WorkflowSynthesizer = WorkflowSynthesizer;
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
...
//# sourceMappingURL=workflow-synthesizer.js.map