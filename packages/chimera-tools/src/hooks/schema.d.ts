...
export declare const HookDefinitionSchema: z.ZodObject<{
    ...
    id: string;
    enabled: boolean;
    event: "error" | "stop" | "pre-tool-use" | "post-tool-use" | "pre-execution" | "post-execution" | "session-start" | "session-end" | "subagent-start" | "subagent-stop" | "user-prompt-submit" | "budget-warning";
    timeout: number;
    priority: number;
    canModify: boolean;
