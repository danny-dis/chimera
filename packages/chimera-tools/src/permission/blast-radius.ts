 ...
 */
export function classifyBlastRadius(command: string): BlastRadiusResult {
 ...
 */
export function classifyChainedCommand(command: string): BlastRadiusResult {
  ...
  const RADIUS_ORDER: Record<BlastRadius, number> = { safe: 0, risky: 1, catastrophic: 2 };
